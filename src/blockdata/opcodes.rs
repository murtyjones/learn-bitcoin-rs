//! Opcodes
//!
//! Bitcoin's script uses a stack-based assembly language. This module
//! defines all of the opcodes.

// Need this because Rust would normally say that things like OP_CHECKMULTISIGVERIFY
// should be camel cased but we don't want to do that for opcodes, which have
